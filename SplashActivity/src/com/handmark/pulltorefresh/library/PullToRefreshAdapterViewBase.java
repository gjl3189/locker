...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T>
     ...
     * when the Adapter View is scrolled to the top and the mode is set to {@link Mode#PULL_FROM_START}. The
     * default value is <var>true</var> if {@link PullToRefreshBase#isPullToRefreshOverScrollEnabled()
     ...
     * getRefreshableView()}. {@link AdapterView#setAdapter(android.widget.Adapter)} setAdapter(adapter)}.
