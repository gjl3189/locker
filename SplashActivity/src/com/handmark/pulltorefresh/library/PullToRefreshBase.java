...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    /**
     * @return Either {@link Orientation#VERTICAL} or {@link Orientation#HORIZONTAL} depending on the scroll
     *         direction.
     */
    ...
    /**
     * Smooth Scroll to position using the longer default duration of {@value #SMOOTH_SCROLL_LONG_DURATION_MS}
     * ms.
     * 
     * @param scrollValue - Position to scroll to
     */
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         * @param direction - One of {@link Mode#PULL_FROM_START} or {@link Mode#PULL_FROM_END} depending on
         *            which direction
         *            the user is pulling. Only useful when <var>state</var> is {@link State#PULL_TO_REFRESH}
